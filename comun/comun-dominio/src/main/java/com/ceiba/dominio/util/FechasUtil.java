...
public class FechasUtil {
	...
	public static final LocalDate[] DIAS_FESTIVOS_COLOMBIA = { LocalDate.of(2021, 1, 1), LocalDate.of(2021, 1, 11),
			...
			LocalDate.of(2021, 11, 01), LocalDate.of(2021, 11, 15), LocalDate.of(2021, 12, 8),
			LocalDate.of(2021, 12, 25), LocalDate.of(2022, 1, 1), LocalDate.of(2022, 1, 10), LocalDate.of(2022, 3, 21),
			LocalDate.of(2022, 4, 14), LocalDate.of(2022, 4, 15), LocalDate.of(2022, 5, 01), LocalDate.of(2022, 5, 30),
